...
public class MediaFile {
	...
	public static final int FILE_TYPE_MUSIC = 100;
	public static final int FILE_TYPE_VIDEO = 101;
	public static final int FILE_TYPE_PIC = 102;
	public static final int FILE_TYPE_APK = 103;
	public static final int FILE_TYPE_DOC = 104;
	public static final int FILE_TYPE_ZIP = 105;
	public static final int FILE_TYPE_FOLDER= 105;
