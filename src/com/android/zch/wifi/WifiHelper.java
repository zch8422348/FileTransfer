...
/**
 * @Title: WifiHelper.java
 * @Package com.android.touchjet.wifi
 * @Description: TODO do something for wifi-ap
 * @author zch:qw8shop@gmail.com
 * @date 2015-1-29 上午10:59:13
 * @version V1.0
 */
public class WifiHelper {
	private static WifiHelper wifiAdmin = null;
	...
	public static WifiHelper getInstance(Context context) {
		if (wifiAdmin == null) {
			Log.e("sss", "danli---------00000---------------");
			wifiAdmin = new WifiHelper(context);
			return wifiAdmin;
		}
		Log.e("sss", "danli-----------11111-------------");
		return wifiAdmin;
	}
	...
	private WifiHelper(Context context) {
		...
		Log.e(tag, "this.wifim==null" + (this.mWifiManager == null));
	}
	...
	// Method method = null;
	// try {
	// String wifiApName = wifiApInfo.wifiApName;
	// String wifiApPassword = wifiApInfo.wifiApPassword;
	//
	// method = wifiManager.getClass().getMethod("setWifiApEnabled", new Class[]
	// { WifiConfiguration.class, Boolean.TYPE });
	// WifiConfiguration netConfig = new WifiConfiguration();
	// if (wifiApName == null)
	// netConfig.SSID = DEFAULT_WIFI_AP_NAME;
	// else {
	// netConfig.SSID = wifiApName;
	// }
	//
	// if ((wifiApPassword != null) && (wifiApPassword.length() != 0)) {
	// netConfig.preSharedKey = wifiApPassword;
	// netConfig.allowedKeyManagement.set(1);
	// } else {
	// netConfig.allowedKeyManagement.set(0);
	// }
	//
	// if (enabled) {
	...
	// }
	// method.invoke(wifiManager, new Object[] { netConfig,
